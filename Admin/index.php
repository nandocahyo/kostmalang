...
<head>
  ...
  <title>Halaman Admin KostMalang</title>
  <!-- Bootstrap core CSS-->
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="index.html">Kost Malang</a>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Charts">
          <a class="nav-link" href="index.php?halaman=kost">
            <i class="fa fa-fw fa-home"></i>
            <span class="nav-link-text">Kost</span>
          </a>
        </li>
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tables">
          <a class="nav-link" href="index.php?halaman=komentar">
    ...
    <div class="container-fluid">
    	<?php
                if (isset($_GET['halaman']))
                {
                    ...
                    elseif ($_GET['halaman']=="tambahkost") 
                    {
                    	include 'tambahkost.php';
                    }
                    elseif ($_GET['halaman']=="tambahcustomer") 
                    {
                        include 'tambahcustomer.php';
                    }
                    elseif ($_GET['halaman']=="hapuskost") 
                    {
                        include 'hapuskost.php'; 
                    }
                    elseif ($_GET['halaman']=="ubahkost")
                    {
                        include 'ubahkost.php';
                    }
    ...
    <footer class="sticky-footer">
      <div class="container">
        <div class="text-center">
          <small>Copyright © MalangKost 2018</small>
        </div>
      </div>
    </footer>
