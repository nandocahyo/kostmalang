...
<body> 
			...
			<div class="header">
				...
				<div class="top-nav">
					...
					<ul class="memenu skyblue"><li class="active"><a href="index.php">Home</a></li>
						<li class="grid"><a href="blog.php">Blog</a>		</li>
	...
	<div class="contact">
		<div class="container">
			<center><h2>Pembayaran Sukses</h2></center>
			<center><h3>Terima Kasih atas Kepercayaan anda kepada kami</h3></center>
			<center><a href="index.php" class="btn btn-primary">Kembali ke Beranda</a></center>
		</div>
	</div>
	<!--contact-end-->
	<!--map-start-->
