...
<body> 
	...
	<div class="contact">
		...
		?>
				...
				Nama :<strong><?php echo $detail['nama_cus']; ?></strong> <br>
		<p>
			Telepon :<?php echo $detail['telepon_cus']; ?> <br>
			E-mail :<?php echo $detail['email_cus']; ?>
		</p>
		...
		<div class="row">
			<div class="col-md-7">
				<div class="alert alert-info">
					<strong>Segera Lakukan Pembayaran di Rekening tersebut</strong>
				</div>
			</div>
		</div>
		<a href="detailcont.php" class="btn btn-primary">Konfirmasi Pembayaran</a> 
